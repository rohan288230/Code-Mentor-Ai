...
export default function NetworkTopicViewer() {
  ...
  const handleMarkComplete = async () => {
    try {
      await axios.post('/api/interview/computer-networks/progress', { topicId: id }, { withCredentials: true });
      fetchData();
    } catch (error) {
  ...
  const handleQuizSubmit = async () => {
    ...
    try {
      await axios.post('/api/interview/computer-networks/quiz', { topicId: id, score }, { withCredentials: true });
      setQuizSubmitted(true);
      setQuizScore(score);
      // Also mark topic as complete if they pass
  ...
  const toggleBookmark = async (type, itemId) => {
    try {
      await axios.post('/api/interview/computer-networks/bookmark', { type, itemId }, { withCredentials: true });
      fetchData(); // refresh bookmarks
    } catch (error) {
      ...
      <div className="sticky top-0 z-40 bg-[#0a0a0a]/80 backdrop-blur-md border-b border-white/10">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="font-bold text-lg hidden sm:block">{topic.title}</h1>
          </div>
        ...
        {/* Tabs */}
        <div className="max-w-6xl mx-auto px-6 flex gap-8 border-t border-white/5 pt-2">
          <button
            ...
            {quizSubmitted ? (
              <div className={`p-8 rounded-2xl border text-center ${
                ...
                <h2 className="text-3xl font-bold mb-2">
                  {quizScore >= topic.quiz.passingScore ? 'Congratulations!' : 'Keep Practicing!'}
                </h2>
              ...
              <>
                <div className="bg-blue-900/20 border border-blue-500/30 p-6 rounded-2xl mb-8">
                  ...
                  <p className="text-blue-200">Test your knowledge. Passing score: {topic.quiz.passingScore}%</p>
                </div>
