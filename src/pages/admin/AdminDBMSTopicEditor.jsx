...
export default function AdminDBMSTopicEditor() {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      if (activeTab === 'notes') {
        const res = await axios.get(`/api/admin/dbms/topic/${id}/notes`, { withCredentials: true });
        setNotesContent(res.data.content || '');
      } else if (activeTab === 'questions') {
        const res = await axios.get(`/api/admin/dbms/topic/${id}/questions`, { withCredentials: true });
        setQuestions(res.data);
      } else if (activeTab === 'quiz') {
        const res = await axios.get(`/api/admin/dbms/topic/${id}/quiz`, { withCredentials: true });
