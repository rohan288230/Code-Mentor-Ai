  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white p-6 pb-24">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        {/* Header Section */}
        <div className="bg-gradient-to-r from-blue-900/40 to-indigo-900/40 rounded-3xl p-8 border border-white/10 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-wrap gap-4 items-center">
              <button
                onClick={() => navigate('/interview/dbms/mock')}
                className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 rounded-xl font-semibold transition-all shadow-[0_0_20px_rgba(59,130,246,0.3)]"
              >
              ...
              <button
                onClick={() => navigate('/interview/dbms/sql')}
                className="flex items-center gap-2 px-6 py-3 bg-black/40 hover:bg-black/60 border border-white/10 rounded-xl font-semibold transition-all"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {subject.topics?.map((topic, index) => {
              ...
              return (
                <div 
                  key={topic._id}
                  onClick={() => navigate(`/interview/dbms/topic/${topic._id}`)}
                ...
                >
                  ...
                  <div className="flex justify-between items-start mb-4">
                    ...
                    {isCompleted && (
                      <div className="bg-blue-500/20 text-blue-400 px-3 py-1 rounded-full text-xs font-semibold flex items-center gap-1 border border-blue-500/20">
